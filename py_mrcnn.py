...
tensorflowNet = cv2.dnn.readNetFromTensorflow('frozen_inference_graph_mrcnn.pb', 'pbpb_mrcnn.pbtxt')
video_capture = cv2.VideoCapture("training_video.mp4")
i=0
zeros=set()
ones=set()
